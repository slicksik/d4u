class DoctorsController < ApplicationController
    ...
    before_filter :get_profession_area
  ...
  # GET selected Profession's Area
  def get_profession_area
    @prarea = @profession.areas.find(params[:area_id])
  end
  ...
  # GET /doctors/1.json
  def show
    @doctor = @prarea.doctors.find(params[:id])
